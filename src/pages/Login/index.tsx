...
const Login = () => {
  ...
  return (
    ...
    //   <div className="flex flex-col font-bree items-center border gap-5 w-auto">
    //     <h2 className="pt-5">Зареєструся за допомогою Google</h2>
    <button
    ...
    //   <div>{/* <button onClick={handleFacebookLogin}>FACEBOOK</button> */}</div>
    // </div>
  );
};
