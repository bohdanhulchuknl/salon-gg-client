...
const HomeCarousel = ({ slides, user }: ICaruosel) => {
  ...
  return (
    <div className=" relative w-full max-h-[940px]  h-[calc(100vh-80px)]">
      ...
      <div
        className="absolute inset-0 flex  font-poppins text-white pl-20 pt-10"
        id="Home"
      >
      ...
      <div className="absolute inset-0 flex items-end justify-between pb-20 px-20 font-poppins">
